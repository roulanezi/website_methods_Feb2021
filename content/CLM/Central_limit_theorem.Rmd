...
* Apply the Central Limit Theorem on asample in R, 
* Generate a random sample from a given dataset, 
* Identify if a distribution is skewed or not using a histogram
...
* You should be able to now apply the Central Limit Theorem using R
* You can generate a sample from any dataset using the `sample()` function
* You shoul know how to use the `hist()` function.
