...
{{% notice info %}}
* Measure correlations between variables in R.
* Visualise relationships using the correlogram package.
{{% /notice %}}
...
{{% notice info %}}
* You can measure the correlation between two variables using the ` cor()` function
* If you can visualise your correlation you can use the `corrgram` package
{{% /notice %}}
