...
{{% notice info %}}
* use the `dplyr` package to clean and recode your dataset.
{{% /notice %}}
...
{{% notice info %}}
* The dplyr package offers a number of functions to clean and reshape your dataset including; `rename()` and `select()`.
{{% /notice %}}
