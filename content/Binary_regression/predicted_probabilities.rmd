...
{{% notice info %}}
* use the effects package to visualise predicted probabilities.
{{% /notice %}}
...
{{% notice info %}}
* You can use the `allEffects()` function as well as `plot()` function to display logistic regression model data
{{% /notice %}}
